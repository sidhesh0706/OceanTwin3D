...
- Open `C:\Users\Sidhesh\PycharmProjects\sih` in PyCharm and select its `.venv/Scripts/python.exe` interpreter.
...
- [Shared GitHub repository](https://github.com/sidhesh0706/OceanTwin3D)
